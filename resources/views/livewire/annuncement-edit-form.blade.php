<div>
    <form class="shadow p-5 {{ $theme . '-theme2' }} toBlack2" wire:submit.prevent='update' enctype="multipart/form-data">
        @csrf
        {{-- <x-validate-errors /> --}}
        @if (session('message'))
            <div class="alert alert-info position-absolute top-50 start-50 translate-middle" role="alert"
        ...
        <div class="mb-3">
            ...
            <input type="text" wire:model="title"
                class="form-control toBlack3 {{ $theme . '-theme4' }} @error('title') is-invalid @enderror"
                id="title">
        ...
        <div class="mb-3">
            ...
            <select wire:model.defer="category" id="category"
                ...
                @foreach ($categories as $category)
                    @if ($category != $annuncement->category->name)
        ...
        {{-- <div class="mb-3">
            ...
            <input id="temporary_images" wire:model="temporary_images" type="file" name="images" multiple
                class="form-control toBlack3 {{ $theme . '-theme4' }} shadow @error('temporary_images.*') is-invalid @enderror"
                placeholder="Img" />
        ...
        <div class="mb-3">
            ...
            <input type="decimal" wire:model="price"
                class="form-control toBlack3 {{ $theme . '-theme4' }} @error('price') is-invalid @enderror"
                id="price">
            @error('price')
                {{ $message }}
            @enderror
        ...
        <div class="mb-3">
            ...
            <textarea wire:model="description"
                class="toBlack3 {{ $theme . '-theme4' }} form-control @error('description') is-invalid @enderror" cols="10"
                rows="10"></textarea>
            @error('description')
                {{ $message }}
            @enderror
        ...
        <div class="row">
            <div class="col-12 mb-2"> <button type="submit" class="btn btn-presto">{{ __('ui.Salva') }}</button></div>
